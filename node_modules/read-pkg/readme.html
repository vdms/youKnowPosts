<h1 id="read-pkg-build-status-https-travis-ci-org-sindresorhus-read-pkg-svg-branch-master-https-travis-ci-org-sindresorhus-read-pkg-">read-pkg <a href="https://travis-ci.org/sindresorhus/read-pkg"><img src="https://travis-ci.org/sindresorhus/read-pkg.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<pre><code class="lang-js">var readPkg = require(&#39;read-pkg&#39;);
...
<h2 id="api">API</h2>
<h3 id="readpkg-path-options-">readPkg([path], [options])</h3>
<p>Returns a promise that resolves to the parsed JSON.</p>
<h3 id="readpkg-sync-path-options-">readPkg.sync([path], [options])</h3>
