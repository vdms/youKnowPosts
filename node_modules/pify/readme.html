<h1 id="pify-build-status-https-travis-ci-org-sindresorhus-pify-svg-branch-master-https-travis-ci-org-sindresorhus-pify-">pify <a href="https://travis-ci.org/sindresorhus/pify"><img src="https://travis-ci.org/sindresorhus/pify.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<h2 id="api">API</h2>
<h3 id="pify-input-promisemodule-options-">pify(input, [promiseModule], [options])</h3>
...
<p>Type: <code>array</code> of (<code>string</code>|<code>regex</code>)<br>Default: <code>[/.+Sync$/]</code></p>
...
<pre><code class="lang-js">const pify = require(&#39;pify&#39;);
