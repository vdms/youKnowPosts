<h1 id="load-json-file-build-status-https-travis-ci-org-sindresorhus-load-json-file-svg-branch-master-https-travis-ci-org-sindresorhus-load-json-file-">load-json-file <a href="https://travis-ci.org/sindresorhus/load-json-file"><img src="https://travis-ci.org/sindresorhus/load-json-file.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<pre><code class="lang-js">const loadJsonFile = require(&#39;load-json-file&#39;);
...
<h2 id="api">API</h2>
<h3 id="loadjsonfile-filepath-">loadJsonFile(filepath)</h3>
<p>Returns a promise that resolves to the parsed JSON.</p>
<h3 id="loadjsonfile-sync-filepath-">loadJsonFile.sync(filepath)</h3>
