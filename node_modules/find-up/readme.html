<h1 id="find-up-build-status-https-travis-ci-org-sindresorhus-find-up-svg-branch-master-https-travis-ci-org-sindresorhus-find-up-">find-up <a href="https://travis-ci.org/sindresorhus/find-up"><img src="https://travis-ci.org/sindresorhus/find-up.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
    ...
    └── sindresorhus
        ...
        └── foo
            └── bar
                ├── baz
                └── example.js
</code></pre><pre><code class="lang-js">// example.js
...
<h2 id="api">API</h2>
<h3 id="findup-filename-options-">findUp(filename, [options])</h3>
<p>Returns a promise for the filepath or <code>null</code>.</p>
<h3 id="findup-sync-filename-options-">findUp.sync(filename, [options])</h3>
